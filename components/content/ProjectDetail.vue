...
const profolioProjects = [
  {
    company: 'CryptoVibe',
    year: '2025',
    title: 'Multi-Exchange Crypto Portfolio with Market Analytics',
    description: 'CryptoVibe is a comprehensive crypto dashboard using Vue.js and Node.js, featuring multi-exchange API integration, real-time market data streaming, and interactive sentiment analysis charts.',
    tools: ['Vue3', 'Node.js', 'websocket', 'highcharts.js', 'shadcn'],
